...
class Reflector {
	 ...
	 *
	 * @template TAttribute of class-string<\Attribute>|null
	 *
	 ...
	 * @phpstan-return (TAttribute is null ? array<\ReflectionAttribute> : array<TAttribute>)
	 */
	 ...
	 * @param class-string<\Attribute>|null  $attribute The attribute name to filter by, or null for all attributes.
	 * @param int                            $flags Flags to pass to getAttributes().
	 * @param bool                           $inherit Whether to include attributes from parent classes.
