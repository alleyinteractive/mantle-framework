 ...
 * @method static \Mantle\Http_Client\Pending_Request with_json(array $data)
 ...
 * @method static \Mantle\Http_Client\Pending_Request stream(string|null $file = null)
 ...
 * @method static \Mantle\Http_Client\Response|\Mantle\Http_Client\Response get(string $url, array|string|null $query = null)
 * @method static \Mantle\Http_Client\Response|\Mantle\Http_Client\Response head(string $url, array|string|null $query = null)
 * @method static \Mantle\Http_Client\Response|\Mantle\Http_Client\Response post(string $url, array $data = null)
 * @method static \Mantle\Http_Client\Response|\Mantle\Http_Client\Response patch(string $url, array $data = null)
 * @method static \Mantle\Http_Client\Response|\Mantle\Http_Client\Response put(string $url, array $data = null)
 * @method static \Mantle\Http_Client\Response|\Mantle\Http_Client\Response delete(string $url, array $data = [])
 * @method static \Mantle\Http_Client\Response|\Mantle\Http_Client\Response send(string $method, string $url, array $options = [])
