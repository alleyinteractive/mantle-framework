 ...
 * @method static \Mantle\Http\Routing\Rest_Route_Registrar rest_api( string $namespace, \Closure|string $callback_or_route = null, \Closure|array $callback_or_args = [] )
 * @method static void model( string $model, string $controller ): void
 * @method static \Mantle\Http\Routing\Route_Registrar middleware( array|string|\Closure $middleware )
