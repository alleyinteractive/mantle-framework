 ...
 * @method static \static alias_middleware(string $name, string $class)
 * @method static array get_middleware_groups()
 * @method static \static middleware_group(string $name, array $middleware)
 ...
 * @method static \static pass_requests_to_wordpress(callable|bool $callback)
