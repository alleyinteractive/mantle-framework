 ...
 * @method static \Mantle\Database\Query\Post_Query_Builder<static> olderThan( DateTimeInterface|int $date )
 * @method static \Mantle\Database\Query\Post_Query_Builder<static> olderThanOrEqualTo( DateTimeInterface|int $date )
 * @method static \Mantle\Database\Query\Post_Query_Builder<static> older_than( DateTimeInterface|int $date )
