	...
	public static function txt_handler( $message, $title, $args ): void {
		...
		if ( false !== strpos( (string) $message, 'database' ) ) {
			...
			if ( ! file_exists( $path ) ) {
				...
				echo "    \033[33mhttps://raw.githubusercontent.com/alleyinteractive/mantle-ci/HEAD/wp-tests-config-sample.php\033[0m \n\n";
				echo "    \033[33mwget https://raw.githubusercontent.com/alleyinteractive/mantle-ci/HEAD/wp-tests-config-sample.php -O {$path}\033[0m \n\n";
