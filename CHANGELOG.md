...
- Change the installation manager's `theme()` method to use the `setup_theme`
  hook instead of waiting for `muplugins_loaded`. This will allow the proper
  theme `functions.php` to loaded when testing.
